...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description1', @value = N'A courtesy title. For example, Mr. or Ms.  ---test ', @level0type = N'SCHEMA', @level0name = N'Person', @level1type = N'TABLE', @level1name = N'Person', @level2type = N'COLUMN', @level2name = N'Title';
